...
SELECT	DISP.SERIAL, DISP.NOMBREDISP, PREST.CS_USERITCREO, PREST.FECPRESTAMO, PREST.FECDEVOLUCIONESTIMADA, US.NOMBREUSER, US.APELLIDO, US.LEGAJO
...
SELECT DISP.SERIAL, DISP.NOMBREDISP,PREST.CS_USERITCREO, PREST.CS_USERITFIN, PREST.FECPRESTAMO, PREST.FECDEVOLUCIONESTIMADA, US.NOMBREUSER,US.APELLIDO, US.LEGAJO
FROM TB_PRESTAMO PREST 
JOIN TB_DISPOSITIVO DISP ON DISP.ID=PREST.CS_DISPOSITIVO
JOIN TB_USUARIO US ON US.ID=PREST.CS_USUARIO
JOIN TB_USER_IT ITCREADOR ON ITCREADOR.ID = PREST.CS_USERITCREO
JOIN TB_USER_IT ITFINALIZA ON ITFINALIZA.ID = PREST.CS_USERITFIN
...
CREATE PROCEDURE SP_FILTRO_USER_IT_CREADOR
...
JOIN TB_USUARIO US ON US.ID=PREST.CS_USUARIO
JOIN TB_USER_IT ITCREADOR ON ITCREADOR.ID = PREST.CS_USERITCREO
JOIN TB_USER_IT ITFINALIZA ON ITCREADOR.ID = PREST.CS_USERITFIN
WHERE ITCREADOR.ID = @IDUSERIT
ORDER BY PREST.FECPRESTAMO DESC
